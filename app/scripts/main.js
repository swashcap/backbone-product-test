...
app.initialize = function () {
   ...
   */
  var plansView = new app.PackagesView(this.data.packages);
  var unitsView = new app.UnitsView(this.data.units);
  var featuresView = new app.FeaturesView(this.data.features);
};
